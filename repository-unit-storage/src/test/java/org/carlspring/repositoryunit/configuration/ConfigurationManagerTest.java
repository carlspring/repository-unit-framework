...
public class ConfigurationManagerTest
{
    ...
    public void testStoreConfiguration()
            throws IOException
    {
        String resolver1 = "org.carlspring.repositoryunit.storage.resolvers.InMemoryLocationResolver";
        String resolver2 = "org.carlspring.repositoryunit.storage.resolvers.FSLocationResolver";
