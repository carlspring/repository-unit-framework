 ...
 * @author mtodorov
 */
public class ArtifactManagementRestletTest
        extends AbstractRepositoryUnitTestCase
{
    ...
    @Test
    public void testCreateGetAndDeleteArtifact()
            throws Exception
    {
        // NOTE: No assertions are made in this method, as the client will throw
        //       an exception if something is wrong and thus simply fail the tests.
